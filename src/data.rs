...
pub mod gamemode {
    ...
    pub fn set_gamemode(){
        ...
        println!("[smashline_totk::data] HDR: {}",hdr_enabled);
        ...
        println!("[smashline_totk::data] Ult-S: {}",ultS_enabled);
        {
            if hdr_enabled{
...
const IDENTIFIER: &str = "smashline_totk";
...
fn copy_dir_all(src: impl AsRef<Path>, dst: impl AsRef<Path>) -> io::Result<()> {
    ...
    for entry in std::fs::read_dir(src)? {
        ...
        if ty.is_dir() {
            ...
            println!("[smashline_totk::data] copied {} to {}",entry.file_name().to_str().unwrap(),dst.as_ref().to_str().unwrap());
        }
    }
    Ok(())
}
...
pub fn patch_files()
{
    unsafe {
        ...
        {
            println!("[smashline_totk::data] WTF?");
            return;
        }
        ...
        for slot in 1..slots {
            ...
            println!("[smashline_totk::data] copied motion files to {}",destFile);
        }
